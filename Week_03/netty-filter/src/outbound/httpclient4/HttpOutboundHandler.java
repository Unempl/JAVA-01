...
public class HttpOutboundHandler {
    ...
    public HttpOutboundHandler(List<String> backends) {
        ...
        proxyService = new ThreadPoolExecutor(cores, cores,
                ...
                new httpclient4.NamedThreadFactory("proxyService"), handler);
    ...
    private void handleResponse(final FullHttpRequest fullRequest, final ChannelHandlerContext ctx) throws Exception {
